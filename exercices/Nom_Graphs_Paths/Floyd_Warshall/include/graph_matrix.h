...
typedef struct graph {
  ...
  double **dist;       /**< Distance matrix used to compute shortest paths lengths via Floyd-Warshall algorithm */
  int **parent;        /**< Parent matrix used to reconstruct shortest paths */
} graph_s;
